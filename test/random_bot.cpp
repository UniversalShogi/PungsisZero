...
main() {
    ...
    MCTSActionProvider* sente = new MCTSActionProvider(new MCTS(model), 100, 600, "MCTS_Sente");
    MCTSActionProvider* gote = new MCTSActionProvider(new MCTS(model), 100, 600, "MCTS_Gote");
    ...
    std::cout << selfPlay.moveCount << std::endl;
