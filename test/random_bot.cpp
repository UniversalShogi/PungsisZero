...
main() {
    ...
    ActionProvider* sente = new MCTSActionProvider(new MCTS(model, start), 100, 600, "MCTS_Sente");
    ActionProvider* gote = new MCTSActionProvider(new MCTS(model, start), 100, 600, "MCTS_Gote");
